...
void insert(string tableName, const vector<short>& v_short, TFHESecretKeySet& key) {
    vector<Tfhe<short>> v_short_cipher = {};

    for(int i = 0; i < v_short.size(); ++i) {
        v_short_cipher.push_back(Tfhe<short>::Encrypt(v_short[i], key));
    }

    insert_row(tableName, v_short_cipher);
...
void query_where(string tableName, string columnName, string op, short condition, TFHESecretKeySet& key, TFHEParameters& params) {
...
void query_join(string tableName_1, string tableName_2, string columnName_1, string columnName_2, TFHESecretKeySet& key, TFHEParameters& params) {
    try {
        ...
        vector<Tfhe<short>> index_cipher = {};
...
void query_sum_where(string tableName, string columnName, string op, short condition, TFHESecretKeySet& key, TFHEParameters& params) {
...
void query_count_where(string tableName, string columnName, string op, short condition, TFHESecretKeySet& key, TFHEParameters& params) {
